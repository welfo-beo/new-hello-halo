...
import { TOOL_TIMEOUT, imageResult, textResult, withTimeout } from './shared'

export async function handleBrowserSnapshot(args: { verbose?: boolean; filePath?: string }) {
...
in the DevTools Elements panel (if any).`,
  ...
  async (args) => handleBrowserSnapshot(args)
)
